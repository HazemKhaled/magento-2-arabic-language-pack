...
console.log(`\u001b[32mThere is ${openapiMixinsNames.length} service within the openapi docs`);
console.log(
...
console.log(`\x1b[31mThere is ${noDocActions.length} end-points not documented!`);
