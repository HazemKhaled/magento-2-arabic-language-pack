...
const { ValidationError, MoleculerClientError } = Errors;
...
describe("Test 'orders' service", () => {
  ...
  describe("Test 'orders' action", () => {
    it('should reject an ValidationError', () => {
      expect(broker.call('orders.create')).rejects.toBeInstanceOf(
        ValidationError
      );
    });
  ...
  describe("Test 'orders.list' action", () => {
    it('should reject an ValidationError', () => {
      expect(broker.call('orders.list')).rejects.toBeInstanceOf(
        ValidationError
      );
    });
  ...
  describe("Test 'orders.update' action", () => {
    it('should reject an ValidationError', () => {
      expect(broker.call('orders.update')).rejects.toBeInstanceOf(
        ValidationError
      );
    });
