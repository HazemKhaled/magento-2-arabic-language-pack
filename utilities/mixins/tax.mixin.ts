      ...
      async handler(ctx) {
        {
          ...
          if (!this.checkAddressCountry(ctx.params.instance)) {
            return {
              code: 1234,
          ...
          if (!this.checkItemTaxClass(ctx.params.item)) {
            ...
            this.sendMail({
              ...
              text: `Item under this sku '${ctx.params.item.sku}' has no tax class.`,
            });
          ...
          const taxClass = ctx.params.item.taxClass;
          const country = ctx.params.instance.address.country;
