...
export const UpdateMembershipValidation = {
  ...
  cost: [{ type: 'number', positive: true, optional: true }, { type: 'enum', values: [0], optional: true  }],
  discount: [{ type: 'number', positive: true, optional: true }, { type: 'enum', values: [0], optional: true  }],
