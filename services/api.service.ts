...
import { Context, ServiceSchema, Service, ServiceBroker } from 'moleculer';
        ...
        routes: [
          {
            ...
            aliases: {
              ...
              'GET catalog/products/:sku':
                'products-instances.getInstanceProduct',
              ...
              'PATCH catalog/products':
                'products-instances.bulkProductInstance',
              ...
              // paymentGateway
              'POST paymentGateway/:type/transaction':
