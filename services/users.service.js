					...
					.then(async () => {
						...
						try {
							...
							if (!instance) {
								...
								if (consumer_key === instance.webhook_hash && consumer_secret === instance.secret) {
									return {
									...
									return this.Promise.reject(new MoleculerClientError("consumer_key or consumer_secret is invalid!", 422, "", [{ field: "consumer_key", message: "is not valid"}, { field: "consumer_secret", message: "is not valid"}]));
								}								
							}
						} catch(err) {
